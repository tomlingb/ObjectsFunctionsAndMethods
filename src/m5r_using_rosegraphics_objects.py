...
#            it keeps the window open until the user clicks. useful for when
#  you want to see how an animation turned out as without it the window will
#  close as soon as it is finished.
#
